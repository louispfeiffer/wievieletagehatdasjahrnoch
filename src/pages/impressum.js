        ...
        <html>
            <body>
                ...
                <div class="container mx-auto px-4 mt-8">
                    <h1 class="text-xl font-bold text-center my-5">Impressum</h1>
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        <div class="mb-4">
                            <h2 class="text-lg font-semibold">Angaben gem. § 5 TMG:</h2>
                            <p>
                                Louis Pfeiffer
                                Birkbuschgarten 2
                                12167, Berlin
                            ...
                            <div class="mb-4">
                                <h2 class="text-lg font-semibold">Kontaktaufnahme:</h2>
                                <p>Telefon: 0176 72782147<br></br>E-Mail: <a href="mailto:louispfeiffer@info.com" class="text-blue-500">louispfeiffer@info.com</a></p>
                            </div>
                            <div class="mb-4">
                                <h2 class="text-lg font-semibold">Umsatzsteuer-ID</h2>
                                <p>Umsatzsteuer-Identifikationsnummer gem. § 27 a Umsatzsteuergesetz:<br></br>DE XXX XXX XXX</p>
                            </div>
                            <div class="mb-4">
                                <h2 class="text-lg font-semibold">Haftungsausschluss – Disclaimer:</h2>
                                <p>Alle Inhalte unseres Internetauftritts wurden mit größter Sorgfalt und nach bestem Gewissen erstellt.
                                    ...
                                    der Kenntniserlangung einer konkreten Rechtsverletzung möglich.
                                    Bei Bekanntwerden von den o.g. Rechtsverletzungen werden wir diese Inhalte unverzüglich entfernen.
                                </p>
                            </div>
                            <div class="mb-4">
                                <h2 class="text-lg font-semibold">Haftungsbeschränkung für externe Links</h2>
                                <p>Unsere Webseite enthält Links auf externe Webseiten Dritter.
                                    ...
                                    Die externen Links wurden zum Zeitpunkt der Linksetzung auf eventuelle Rechtsverstöße überprüft
                                    und waren im Zeitpunkt der Linksetzung frei von rechtswidrigen Inhalten. Eine ständige inhaltliche
                                    Überprüfung der externen Links ist ohne konkrete Anhaltspunkte einer Rechtsverletzung nicht möglich.
                                    Bei direkten oder indirekten Verlinkungen auf die Webseiten Dritter, die außerhalb unseres Verantwortungsbereichs liegen,
                                    würde eine Haftungsverpflichtung ausschließlich in dem Fall nur bestehen, wenn wir von den Inhalten Kenntnis erlangen und
                                    es uns technisch möglich und zumutbar wäre, die Nutzung im Falle rechtswidriger Inhalte zu verhindern.
